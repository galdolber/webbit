...
public class FlashPolicyFileTest {
  ...
  public void returnsCrossDomainXML() throws IOException, InterruptedException, ExecutionException {
    WebServer webServer =
        createWebServer(59504).add(new StringHttpHandler("text/plain", "body")).start().get();
  ...
  @Test
  public void returnsCrossDomainXMLWithPublicPort() throws IOException, InterruptedException,
      ExecutionException {
    ...
    WebServer webServer =
        createWebServer(executor, address, publicUri).add(
