...
public abstract class WebSocketClientVerification {
  ...
  @Test
  public void server_echoes_byte_binary_message_with_offset_and_length_immediately()
  ...
  private void assertEchoed(final byte[] message, final int offset, final int length)
      throws InterruptedException {
