...
public class StaleConnectionTest {
  ...
  @Test
  public void closesConnectionAfterTimeoutIfClientKeepsConnectioOpen() throws IOException,
    ...
    webServer.staleConnectionTimeout(100).add(new HttpHandler() {
      ...
      public void handleHttpRequest(HttpRequest request, HttpResponse response, HttpControl control)
        ...
        response.header("Content-Length", (String) null); // This makes the client hang until the
