...
public class SslTest {
  ...
  public void setsSecureHttpsServerHeader() throws Exception {
    ...
    WebServer webServer =
        createWebServer(10443).setupSsl(keystore, "webbit").add(
            new ServerHeaderHandler("My Server")).add(new StringHttpHandler("text/plain", "body"));
  ...
  @BeforeClass
  public static void disableCertValidationSetUp() throws NoSuchAlgorithmException,
