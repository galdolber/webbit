...
public class CompressionTest {
  ...
  @Test
  public void compressedPostIsUncompressedProperly() throws IOException, ExecutionException,
  ...
  @Test
  public void compressedResponseIsSentProperly() throws IOException, ExecutionException,
      InterruptedException {
    webServer.add(new HttpHandler() {
      @Override
      public void handleHttpRequest(HttpRequest request, HttpResponse response, HttpControl control)
