...
public class Main {
  public static class Pusher {
    ...
    public void pushPeriodicallyOn(ExecutorService webThread) throws InterruptedException,
        ExecutionException {
      while (true) {
        sleep(1000);
  ...
  public static void main(String[] args) throws Exception {
    ...
    WebServer webServer = createWebServer(webThread, 9876).add("/events", new EventSourceHandler() {
      @Override
    ...
    }).add(new EmbeddedResourceHandler("samples/eventsource/content")).start().get();
