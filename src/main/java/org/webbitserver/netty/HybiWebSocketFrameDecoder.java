...
public class HybiWebSocketFrameDecoder extends ReplayingDecoder<HybiWebSocketFrameDecoder.State> {
  ...
  @Override
  protected Object decode(ChannelHandlerContext ctx, final Channel channel, ChannelBuffer buffer,
      ...
      case PAYLOAD: {
        ...
        if (frameOpcode == OPCODE_CLOSE) {
          EncodingHybiFrame close =
              new EncodingHybiFrame(OPCODE_CLOSE, true, 0, outboundMaskingKey, ChannelBuffers
                  .buffer(0));
