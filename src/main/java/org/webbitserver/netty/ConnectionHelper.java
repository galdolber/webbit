...
abstract class ConnectionHelper {
  ...
  public ConnectionHelper(Executor executor, Thread.UncaughtExceptionHandler exceptionHandler,
  ...
  public void fireOnClose(final ChannelStateEvent e) {
    ...
    final Thread.UncaughtExceptionHandler uncaughtExceptionHandler =
        webbitExceptionWrappingExceptionHandler(e.getChannel());
  ...
  protected Thread.UncaughtExceptionHandler webbitExceptionWrappingExceptionHandler(
