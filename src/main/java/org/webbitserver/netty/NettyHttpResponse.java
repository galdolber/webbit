...
public class NettyHttpResponse implements org.webbitserver.HttpResponse {
  ...
  public NettyHttpResponse(ChannelHandlerContext ctx, HttpResponse response, boolean isKeepAlive,
  ...
  public NettyHttpResponse error(Throwable error) {
    ...
    exceptionHandler.uncaughtException(Thread.currentThread(), WebbitException.fromException(error,
        ctx.getChannel()));
  ...
  private void flushResponse() {
    try {
      ...
      exceptionHandler.uncaughtException(Thread.currentThread(), WebbitException.fromException(e,
          ctx.getChannel()));
    }
  }
