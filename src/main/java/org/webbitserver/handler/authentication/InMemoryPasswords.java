...
/**
 * Implementation of PasswordAuthenticator that verifies usernames and password from a prepopulated
 * hashmap.
 */
public class InMemoryPasswords implements PasswordAuthenticator {
  ...
  @Override
  public void authenticate(HttpRequest request, String username, String password,
      ResultCallback callback, Executor handlerExecutor) {
