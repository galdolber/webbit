...
public interface HttpRequest extends DataHolder {
  ...
  @Override
  HttpRequest data(String key, Object value); // Override DataHolder to provide more specific return
                                              // type.
  ...
  /**
   * A unique identifier for this request. This should be treated as an opaque object, that can be
   * used to track the lifecycle of a request.
   */
  Object id();
